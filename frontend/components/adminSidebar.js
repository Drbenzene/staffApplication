      ...
      <div className="w-full h-full bg-gray-200">
        <div className="flex flex-no-wrap">
          ...
          <div className="absolute lg:relative w-64 h-screen shadow bg-gray-100 hidden lg:block">
            <div className="h-16 w-full flex items-center px-8 cursor-pointer">
              <svg
            ...
            <ul aria-orientation="vertical" className=" py-6">
              ...
              <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2">
                <div className="flex items-center">
                  ...
                  <span onClick={dropDownShow} className="ml-[50%]">
                          {dropShow === true ? (
                            <AiOutlineDown size="18px" />
                          ) : (
            ...
            <div className="absolute z-40 sm:relative w-64 md:w-96 shadow pb-4 bg-gray-100 lg:hidden transition duration-150 ease-in-out h-full">
              <div className="flex flex-col justify-between h-full w-full">
                ...
                <div className="w-full">
                  <div className="grid justify-center mb-4 w-full px-6">
                  <Link href="/admin/add">
                  <div className="flex mb-5 justify-center items-center mx-10 font-bold bg-black text-white p-2 rounded-full cursor-pointer">
                    <AiOutlinePlusCircle size={"25px"} />
                    <p className="mx-2 text-xs">Assign Task</p>
                  </div>
                  </Link>
              ...
              <div className="hidden lg:flex w-full pr-6">
                ...
                <Link href="/admin/add">
                  <div className="flex justify-center items-center mx-10 font-bold bg-black text-white p-2 rounded-full cursor-pointer w-full">
                    <AiOutlinePlusCircle size={"25px"} />
                    <p className="mx-2">Assign Task</p>
                  </div>
                  </Link>
