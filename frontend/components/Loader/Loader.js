        ...
        <div className="px-4 py-12 bg-white">
          <div className="mx-auto flex justify-center">
            <div className="relative">
              <div className="w-[70px] h-[70px] border border-indigo-400 rounded-full" />
              <div className="w-[50px] h-[50px] border border-indigo-400 rounded-full absolute top-2.5 right-2.5" />
              <div>
                <svg
